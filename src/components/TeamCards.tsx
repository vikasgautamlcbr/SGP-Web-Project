      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {members.map((member, index) => (
          <div
            ...
            className="rounded-xl border border-white/10 bg-white/5 p-6 transition will-change-transform hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/7"
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="sgpf-icon-tile sgpf-icon-tile-sm">

...
const MINIMUM_TIMESTAMP = 16094592e5;
...
async function createHS256Signature(stringifiedPayload, timestamp, secret) {
  ...
  if (typeof timestamp !== "number" || isNaN(timestamp) || timestamp < MINIMUM_TIMESTAMP) {
    throw new WebhookSignatureFormatError("Invalid signature timestamp, must be a unix timestamp with millisecond precision");
  }
